...
class Article extends Model
{
    ...
    protected $fillable = [
        'title', 'price', 'thumb_image', 'short_description', 'conten', 'additional_conten', 'meta_title', 'meta_keyword', 'meta_description', 'position','display','recommended', 'published', 'slug', 'parent_id', 'longitude', 'latitude', 'link','link_video','link_shopee', 'link_tokopedia', 'more_config', 'admin_config', 'lang', 'equal_id'
    ];
