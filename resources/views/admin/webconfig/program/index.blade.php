                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ route('config.program.create') }}">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        <tbody>
                        @foreach($allprogram as $prg)
                            <tr>
                                <td>{{ $prg->title }}</td>
                                <td class="text-center">@if($prg->published == '1') Yes @else No @endif</td>
                                <td class="text-center col-md-2 col-sm-3">
                                    {!! Form::model($prg, ['route' => ['config.program.destroy', $prg->equal_id], 'method' => 'delete', 'class' => 'form-inline'] ) !!}
                                    <span class="tooltips" data-original-title="Edit">
                                            <a href="{{ route('config.program.edit', $prg->equal_id)}}" class="btn btn-icon-only blue"><i class="fa fa-edit"></i></a>
                                    </span>
                                ...
                                <td class="text-center">
                                    <span class="tooltips" data-original-title="Manage Header Image">
                                        <a href="{{ route('config.headerimage.index', $prg->equal_id) }}" class="btn btn-icon-only purple-wisteria"><i class="fa fa-image"></i></a>
                                    </span>
                                </td>
                            </tr>
                        @endforeach
