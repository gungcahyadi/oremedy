                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ route('config.homeslider.create') }}">
                        ...
                        @if($homeslider->count() > 0)
                            @foreach($homeslider as $hs)
                                <tr>
                                    ...
                                    <td>
                                        <div class="thumbnail">
                                            <img src="{{ $hs->home_slider }}" alt="{{ $hs->name }}">
                                        </div>
                                    </td>
                                    <td class="text-center col-md-2">
                                        {!! Form::model($hs, ['route' => ['config.homeslider.destroy', $hs->equal_id], 'method' => 'delete', 'class' => 'form-inline'] ) !!}
                                        <span class="tooltips" data-original-title="Edit">
                                            <a href="{{ route('config.homeslider.edit', $hs->equal_id)}}" class="btn btn-icon-only blue"><i class="fa fa-edit"></i></a>
                                        </span>
