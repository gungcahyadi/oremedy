...
@section('page-heading')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            @endif
            <li>
                <span>{{ 'Header Image of '.$article->title }}</span>
            </li>
        </ul>
    </div>
    <h3 class="page-title">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase">{{ 'Header Image of '.$article->title }}</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ route('config.headerimage.create', $article->equal_id) }}">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        <tbody>
                        @foreach($headerimages as $hi)
                            <tr>
                                <td>{{ $hi->name }}</td>
                                <td>
                                    <div class="thumbnail">
                                        <img src="{{ asset('assets/front/images/'.$hi->image) }}" alt="{{ $hi->name }}">
                                    </div>
                                </td>
                                <td class="text-center col-md-2 col-sm-3">
                                    {!! Form::model($hi, ['route' => ['config.headerimage.destroy', $hi->equal_id], 'method' => 'delete', 'class' => 'form-inline'] ) !!}
                                    <span class="tooltips" data-original-title="Edit">
                                            <a href="{{ route('config.headerimage.edit', $hi->equal_id)}}" class="btn btn-icon-only blue"><i class="fa fa-edit"></i></a>
                                    </span>
