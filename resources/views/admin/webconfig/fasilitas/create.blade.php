...
@section('page-heading')
    ...
    <h3 class="page-title"> New Fasilitas</h3>
@endsection
            ...
            <div class="portlet light bordered" id="form_wizard_1">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> New Fasilitas</span>
                    </div>

                </div>
                <div class="portlet-body form">
                    {!! Form::open(['route' => 'config.fasilitas.store', 'files' => true, 'class' => 'form-horizontal', 'id' => 'submit_form'])!!}
                                ...
                                @foreach(config('app.all_langs') as $lang)
                                    <div class="tab-pane active" id="{{ 'tab_'.$lang }}">
                                        ...
                                        <div class="form-group {!! $errors->has('categories') ? 'has-error' : '' !!}">
                                            {!! Form::label('categories_'.$lang, 'Categories', ['class' => 'control-label col-md-2']) !!}
                                            <div class="col-md-10">
                                            {!! Form::select('categories[]', []+App\Category::where('type', 'fasilitas')->where('lang', config('app.default_locale'))->pluck('category','id')->all(), null, ['class'=>'form-control select2-multiple', 'multiple' => 'multiple', 'id' => 'select2-categories']) !!}
