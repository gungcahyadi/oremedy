...
<head>
    ...
    <link href="{{ asset('assets/back/pages/css/login.min.css') }}" rel="stylesheet" type="text/css" />
...
<!-- BEGIN LOGO -->
<div class="logo">
    {{--<a href=""><img src="{{ asset('assets/back/pages/img/logo-big.png') }}" alt="" /> </a>--}}
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
@yield('conten')

<div class="copyright"> 2017 © <a href="http://ganeshcomstudio.com">Ganeshcom Studio</a> </div>
<!--[if lt IE 9]>
<script src="{{ asset('assets/back/global/plugins/respond.min.js') }}"></script>
<script src="{{ asset('assets/back/global/plugins/excanvas.min.js') }}"></script>
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
...
<script src="{{ asset('assets/back/pages/scripts/login.min.js') }}" type="text/javascript"></script>
