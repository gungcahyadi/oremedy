...
<meta name="description" content="Blog category {{ $category->category }} at O-Remedy">
<meta name="keywords" content="blog category, {{ $category->category }}, O-Remedy, blog category O-Remedy">
<title>Blog Category {{ $category->category }} - O-Remedy</title>
@endsection
@section('custom-css')
...
<header class="hero-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="header-title">{{ \Lang::get('front.category',[], App::getLocale()).' '.$category->category }}</h2>
            </div>
        </div>
    </div>
</header>
